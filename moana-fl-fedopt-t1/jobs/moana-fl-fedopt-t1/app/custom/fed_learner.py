...
mlflow.set_experiment(experiment_name='MLFlow Moana FedOPT')
...
class FedLearner(Learner):
    ...
    def __init__(
        ...
        lambda_vgg=1e-2,
        path_logs='logs/',
        path_model='/path/to/moana-fl-fedopt-t1/',
        path_data='/path/to/Data/',
        path_weight='weight/',
        path_saved_models='saved_models',
        reg_type='DatasetFolder',
        save_epoch=10,
        path_training_time='/path/to/moana-fl-fedopt-t1/training_time.txt',
    ...
    def train(self, shareable: Shareable, fl_ctx: FLContext, abort_signal: Signal) -> Shareable:
        ...
        for layer_name in new_weights_flat:
            global_w = model_weights[layer_name]
