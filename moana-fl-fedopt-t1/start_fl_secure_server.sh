...
sed -i "s/login.deucalion.macc.fccn.pt/${HOSTNAME}/g" /projects/I20240003/alicia.oliveira/moana-fl-fedopt-t1/workspaces/project.yml
...
sed -i "s/${HOSTNAME}/login.deucalion.macc.fccn.pt/g" /projects/I20240003/alicia.oliveira/moana-fl-fedopt-t1/workspaces/project.yml
