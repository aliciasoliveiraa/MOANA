...
sed -i "s/originalhostname/${HOSTNAME}/g" /path/to/moana-fl-fedopt/workspaces/project.yml
...
sed -i "s/${HOSTNAME}/originalhostname/g" /path/to/moana-fl-fedopt/workspaces/project.yml
